...
- ✅ Has an established design system with design tokens
- ✅ Uses component-based architecture (React, Vue, Svelte, etc.)
...
```jsx
// ❌ BAD: Unclear which breakpoint applies
...
```javascript
// ✅ Ensure correct content paths (JIT mode)
module.exports = {
  content: [
    './src/**/*.{js,jsx,ts,tsx}',
